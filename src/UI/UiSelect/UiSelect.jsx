...
export const UiSelect = ({data, handleChange, className}) => {
    const [selected, setSelected] = useState(data[0] ?? {id: 0, name: 'Нет подарков'})
                                    ...
                                    <Listbox.Option
                                        ...
                                        className={({active}) =>
                                            `relative cursor-default select-none py-2 pl-10 pr-4 ${
                                                active ? 'bg-pink-100 text-pink-700' : 'text-black'
                                            }`
                                        }
                                        value={item}
                                    >
